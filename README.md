...
* [amc - Artemis Messaging Client]([http://awesome.amqp.stuff/](https://github.com/makibytes/amc) - CLI tool to send & receive messages via AMQP 1.0. Supports some Artemis-specific metadata like ANYCAST/MULTICAST.
